...
func TestRunCh(t *testing.T) {
	...
	t.Run("if were errors in first M tasks, than finished not more N+M tasks", func(t *testing.T) {
		...
		workersCount := 10
		maxErrorsCount := 23
		err := RunCh(tasks, workersCount, maxErrorsCount)
...
func TestRunChNonBuffer(t *testing.T) {
	defer goleak.VerifyNone(t)
	...
	t.Run("if were errors in first M tasks, than finished not more N+M tasks", func(t *testing.T) {
		...
		workersCount := 10
		maxErrorsCount := 23
		err := RunChNonBuffer(tasks, workersCount, maxErrorsCount)
